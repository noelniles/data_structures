...
public class IntNode
{
     ...
     *
     * @param head
     *   a head reference for a linked list of integers
     * @return
     *   A new list that is the reverse of original list has been created and a reference
     *   to the head of the new list is returned.
     */
    ...
    public static void print(IntNode head)
    {
        ...
        for (cursor = head; cursor != null; cursor = cursor.getLink()) {
            ...
            if (cursor.getLink() == null)
                ...
                link = cursor.getLink().getData();
            System.out.format("%d -> ", cursor.getData(), link);
        }
        System.out.println("\n----------------------------\n");
    }
}
